    ...
    <div class="goods-table">
        ...
        <el-form ref="form" :model="goodsInfo" label-width="130px" class="goods-form">
            ...
            <el-form-item label="商品小类">
                <el-radio-group class="radio-style" v-model="goodsInfo.SUB_ID" v-for="(item,index) in categorySubList" :key="index" @change="setSubName(item.MALL_SUB_NAME)">
                    <el-radio :label="item._id" style="margin-right:20px">{{item.MALL_SUB_NAME}}</el-radio>
                </el-radio-group><i class="info-style">{{subIdInfo}}</i>
            </el-form-item>
            <el-form-item label="是否选为推荐商品">
        ...
        methods: {
            ...
            imageUrl2(imgUrl){
                this.goodsInfo.IMAGE2 = imgUrl
                 console.log(this.goodsInfo.IMAGE2)
            },
            imageUrl3(imgUrl){
